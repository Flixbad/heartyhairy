 ...
 */
final class Version20250716143517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item ADD created_at DATETIME NOT NULL, CHANGE order_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item DROP created_at, CHANGE user_id order_id INT DEFAULT NULL');
